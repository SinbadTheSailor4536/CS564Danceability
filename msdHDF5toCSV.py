...
def main():
    outputFile1 = open('EntireSongCSV1.csv', 'w')
    csvRowString = ""
    ...
    if prompt == True:
        while prompt:
            ...
            csvAttributeString = raw_input("\n\nIn what order would you like the colums of the CSV file?\n" +
                ...
                " SongID, TimeSignature, TimeSignatureConfidence, Title, Year and songHottness.\n\n" +
            ...
            for attribute in csvAttributeList:
                ...
                if attribute == 'AlbumID'.lower():
                    ...
                    sys.exit()
                elif attribute == 'songHottness'.lower():
                    csvRowString += 'songHottness'
                else:
                    prompt = True
                    print ("==============")
    ...
    basedir = "C:\\Users\\TAEHYUN\\Desktop\\UW Madison\\Summer 2019\\CS564\\millionsongsubset_full.tar\\MillionSongSubset" # "." As the default means the current directory
    ...
    for root, dirs, files in os.walk(basedir):        
        ...
        for f in files:
            ...
            song.songHottness = str(hdf5_getters.get_artist_hotttnesss(songH5File))
            ...
            for attribute in csvAttributeList:
                ...
                if attribute == 'AlbumID'.lower():
                    ...
                    csvRowString += song.songHottness
                else:
